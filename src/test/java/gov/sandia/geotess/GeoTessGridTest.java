...
public class GeoTessGridTest
{
	 ...
	 */
	private static GeoTessGrid grid;
	
	private static double[] x = VectorGeo.getVectorDegrees(30., 90.);
	...
	{
		System.out.println("GeoTessGridTest");

		grid = new GeoTessModel(new File("src/test/resources/permanent_files/unified_crust20_ak135.geotess"))
				.getGrid();
