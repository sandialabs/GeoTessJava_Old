...
{
	private static GeoTessModel modelCrust20;

	private static GeoTessMetaData crust20;

	private static GeoTessMetaData unified;

	@BeforeClass
	public static void setUpBeforeClass() throws Exception
	{
		System.out.println("GeoTessMetaDataTest");
		...
		//System.out.println(modelCrust20);
	...
	{
		//System.out.println(Arrays.toString(metaData.getAttributeNames()));
