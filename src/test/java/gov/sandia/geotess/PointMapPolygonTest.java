...
public class PointMapPolygonTest
{
	...
	private static PointMap pointMap;
	
	/**
	 * Center of the polygon.
	 */
	private static double[] polygonCenter = VectorGeo.getVectorDegrees(30., 90.);
	
	/**
	 * Radius of the polygon in radians.
	 */
	private static double polygonRadius = toRadians(30.);
	...
	{
		System.out.println("PointMapPolygonTest");
	...
	public void testSetPointValue()
	{
		...
		assertEquals(99., pointMap.getPointValue(pointIndex, 0), 1e-12);
		
		pointMap.setPointValue(pointIndex, 0, value);
		
		assertEquals(value, pointMap.getPointValue(pointIndex, 0), 1e-12);
...
//		System.out.println(value-0.07710898F);
	...
	{
		assertEquals(0.07710897922515869F, pointMap.getPointValue(500, 0), 0.F);
	}
